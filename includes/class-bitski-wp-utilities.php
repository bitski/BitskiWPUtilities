...
class Bitski_Wp_Utilities
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Bitski_Wp_Utilities_Loader $loader Maintains and registers all
    ...
    {
        if (defined('BITSKI_WP_UTILITIES_VERSION')) {
            $this->version = BITSKI_WP_UTILITIES_VERSION;
        } else {
            $this->version = '1.0.0';
        }
        $this->plugin_name = 'bitski-wp-utilities';
     ...
     *
     * - Bitski_Wp_Utilities_Loader. Orchestrates the hooks of the plugin.
     * - Bitski_Wp_Utilities_i18n. Defines internationalization functionality.
     * - Bitski_Wp_Utilities_Admin. Defines all hooks for the admin area.
     * - Bitski_Wp_Utilities_Public. Defines all hooks for the public side of
     * the site.
     *
    ...
    private function load_dependencies()
    {
        ...
        require_once plugin_dir_path(
                         dirname(__FILE__)
                     ) . 'includes/class-bitski-wp-utilities-loader.php';
        ...
        require_once plugin_dir_path(
                         dirname(__FILE__)
                     ) . 'includes/class-bitski-wp-utilities-i18n.php';
        ...
        require_once plugin_dir_path(
                         dirname(__FILE__)
                     ) . 'admin/class-bitski-wp-utilities-admin.php';
     ...
     *
     * Uses the Bitski_Wp_Utilities_i18n class in order to set the domain and
    ...
    {
        $plugin_i18n = new Bitski_Wp_Utilities_i18n();
    ...
    {
        $plugin_admin = new Bitski_Wp_Utilities_Admin(
    ...
    {
        $plugin_public = new Bitski_Wp_Utilities_Public(
     ...
     *
     * @return    Bitski_Wp_Utilities_Loader    Orchestrates the hooks of the
     *     plugin.
     * @since     1.0.0
     */
